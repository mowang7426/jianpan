...
NSDictionary *RKWeChatKeycapThemeDefinition(NSInteger theme) {
    switch (theme) {
        ...
        case 4: return RKWeChatKeycapTheme(@"紫藤晚霞", @[@.36,@.20,@.64], @[@.97,@.94,@.99],
            @[@.15,@.07,@.28], @[@.74,@.58,@.92], @[@.42,@.18,@.78], @[@.82,@.50,@.92]);
        case 5: return RKWeChatKeycapTheme(@"柠檬汽泡", @[@.74,@.72,@.12], @[@.99,@.99,@.90],
            @[@.18,@.19,@.04], @[@.90,@.88,@.42], @[@.58,@.58,@.05], @[@.92,@.78,@.16]);
